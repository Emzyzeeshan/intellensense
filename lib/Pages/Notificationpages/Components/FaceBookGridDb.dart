...
class FaceBookGridDb extends StatefulWidget {
  var Hashtag;
  var Griddata;
  FaceBookGridDb(this.Hashtag, {Key? key}) : super(key: key);

  @override
  State<FaceBookGridDb> createState() => _FaceBookGridDbState();
}

class _FaceBookGridDbState extends State<FaceBookGridDb> {
