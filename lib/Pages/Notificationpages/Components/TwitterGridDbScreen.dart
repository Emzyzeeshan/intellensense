...
class TwitterGridDb extends StatefulWidget {
  var Hashtag;
  var Griddata;
  TwitterGridDb(this.Hashtag, {Key? key}) : super(key: key);

  @override
  State<TwitterGridDb> createState() => _TwitterGridDbState();
}

class _TwitterGridDbState extends State<TwitterGridDb> {
