...
class NewsChannelGridDb extends StatefulWidget {
  var Hashtag;
  var Griddata;
  NewsChannelGridDb(this.Hashtag, {Key? key}) : super(key: key);

  @override
  State<NewsChannelGridDb> createState() => _NewsChannelGridDbState();
}

class _NewsChannelGridDbState extends State<NewsChannelGridDb> {
