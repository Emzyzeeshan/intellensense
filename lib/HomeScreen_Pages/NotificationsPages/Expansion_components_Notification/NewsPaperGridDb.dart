...
class NewsPaperGridDb extends StatefulWidget {
  var Hashtag;
  var Griddata;
  NewsPaperGridDb(this.Hashtag, {Key? key}) : super(key: key);

  @override
  State<NewsPaperGridDb> createState() => _NewsPaperGridDbState();
}

class _NewsPaperGridDbState extends State<NewsPaperGridDb> {
