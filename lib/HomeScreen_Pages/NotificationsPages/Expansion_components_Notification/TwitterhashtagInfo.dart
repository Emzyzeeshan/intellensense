...
class TwitterHashTagInfo extends StatefulWidget {
  var choosenhashtag;
  TwitterHashTagInfo(this.choosenhashtag, );

  @override
  State<TwitterHashTagInfo> createState() => _TwitterHashTagInfoState();
}

class _TwitterHashTagInfoState extends State<TwitterHashTagInfo> {
