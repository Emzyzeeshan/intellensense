...
class NewsChannelHashTagInfo extends StatefulWidget {
  var choosenhashtag;
  NewsChannelHashTagInfo(this.choosenhashtag, );

  @override
  State<NewsChannelHashTagInfo> createState() => _NewsChannelHashTagInfoState();
}

class _NewsChannelHashTagInfoState extends State<NewsChannelHashTagInfo> {
